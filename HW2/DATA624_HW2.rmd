...
There are 263 Countries in this dataset. This would be too many plots to use `facet_grid`. Ploting all of the countries in a single graph would be more beneficial for this exercise.
